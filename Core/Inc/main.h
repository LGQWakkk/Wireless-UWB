...
#define G01_IRQ_Pin GPIO_PIN_1
#define G01_IRQ_GPIO_Port GPIOA
#define UWB_TX_Pin GPIO_PIN_2
#define UWB_TX_GPIO_Port GPIOA
#define UWB_RX_Pin GPIO_PIN_3
...
#define G01_CE_Pin GPIO_PIN_12
#define G01_CE_GPIO_Port GPIOA
